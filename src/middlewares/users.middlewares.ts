...
const passwordCSchema: ParamSchema = {
  notEmpty: {
...
const confrimPasswordSchema: ParamSchema = {
  notEmpty: {
...
const userIdSchema: ParamSchema = {
  custom: {
    options: async (value: string, { req }) => {
      ...
      // vào database tìm user đó xem có hay không?
      ...
      // nếu vượt qua hết thì return true
      return true
    }
  }
}
  ...
  checkSchema(
    {
      ...
      password: passwordCSchema,
      confirm_password: confrimPasswordSchema,
  ...
  checkSchema(
    {
      Authorization: {
        ...
        custom: {
          options: async (value, { req }) => {
            // value là Authorization
            // nhưng Authorization: Bearer <access_token> nên ta băm ra [0: Bearer, 1: <access_token>]
            // ta sẽ truy cập access_token bằng [1]
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            try {
              ...
              ;(req as Request).decoded_refresh_token = docoded_refresh_token
            } catch (err) {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            try {
              ...
              // sau khi verify thành công ta được paylod: decoded_email_verify_token vào req
