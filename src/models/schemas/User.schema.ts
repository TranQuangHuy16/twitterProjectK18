...
// interface UserType chỉ dùng để mô tả các thuộc tính | dấu ? là có hay không mô tả cũng đc
// class User dùng để khởi tạo đối tượng đưa lên database và tất cả từ id đều phải đc đưa lên dù nó đc mô tả hay chưa
